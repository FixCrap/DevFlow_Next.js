				...
				<FormField
					...
					render={({ field }) => (
						<FormItem className='flex w-full flex-col'>
							...
							{/*Editor compnent from TinyMCE / The question Editor lesson */}
										...
										<div className='flex-start mt-2.5 gap-2.5'>
											{field.value.map((tag: any) => (
												<Badge
													...
													className='subtle-medium background-light800_dark300 text-light400_light500 flex items-centerjustify-center gap-2 rounded-md border-non px-4 py-2 capitalize'
													key={tag}>
													{tag}
													<Image
														alt='Close icon'
